...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 116.0, 315.0, 128.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 329.0, 470.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "s to_ante"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 329.0, 424.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 716.0, 198.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "r print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 878.0, 339.0, 207.0, 64.0 ],
					"style" : "",
					"text" : "265 0.1 1 795 0.72 1 1325 0.75 1 1855 0.77 1 2385 0.8 1 2915 0.83 8 3445 0.86 10 3975 0.9 14 4505 0.95 20 5035 1 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 514.0, 272.0, 51.0, 20.0 ],
					"style" : "",
					"text" : "bypass"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 484.0, 271.0, 24.0, 24.0 ],
					"style" : ""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 255.0, 76.0, 24.0, 24.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 247.5, 116.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 357.0, 142.0, 47.0, 20.0 ],
									"style" : "",
									"text" : "0...100"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 307.0, 100.0, 50.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 307.0, 167.0, 100.0, 22.0 ],
									"style" : "",
									"text" : "agcThreshold $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 230.0, 167.0, 65.0, 22.0 ],
									"style" : "",
									"text" : "bypass $1"
								}
...
, 							{
								"box" : 								{
									...
									"style" : "",
									"text" : "agcEnabled 1, ratio 4, attack 100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 126.0, 164.0, 79.0, 22.0 ],
									"style" : "",
									"text" : "saveSettings"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 172.25, 249.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 484.0, 306.0, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 577.0, 378.0, 34.0, 22.0 ],
					"style" : "",
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 484.0, 339.0, 73.0, 22.0 ],
					"style" : "",
					"text" : "omx.comp~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 122.0, 492.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 122.0, 417.0, 59.0, 22.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
,
					...
					"patching_rect" : [ 274.0, 73.0, 606.0, 104.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 656.0, 554.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 878.0, 519.0, 207.0, 64.0 ],
					"style" : "",
					"text" : "265 0.1 1 795 0.72 1 1325 0.75 1 1855 0.77 1 2385 0.8 1 2915 0.83 8 3445 0.86 10 3975 0.9 14 4505 0.95 20 5035 1 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1002.0, 666.0, 153.0, 77.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 12.0, 74.0, 315.0, 50.0 ],
					"style" : "",
					"text" : "265 0.1 1 795 0.72 1 1325 0.75 1 1855 0.77 1 2385 0.8 1 2915 0.83 8 3445 0.86 10 3975 0.9 14 4505 0.95 20 5035 1 50"
				}
